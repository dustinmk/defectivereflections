...
export function createBlankTexture(gl: WebGL2RenderingContext, w: number, h: number) {
    const tex = gl.createTexture();
    if (tex === null) {
        throw new Error("Couldn't create texture.");
    }
...
export function createBlankTextureR8(gl: WebGL2RenderingContext, w: number, h: number) {
    const tex = gl.createTexture();
    if (tex === null) {
        throw new Error("Couldn't create texture.");
    }
...
export function createDepthTexture(gl: WebGL2RenderingContext, w: number, h: number) {
    const tex = gl.createTexture();
    if (tex === null) {
        throw new Error("Couldn't create texture.")
    }
